<template>
  <div>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope" width="180px">
            ...
            <el-tooltip effect="dark" content="删除" placement="top" :enterable="false">
              <el-button type="danger" class="el-icon-delete" size="mini" @click="removedUserById(scope.row.id)">
              </el-button>
            </el-tooltip>
    ...
    <!-- 分配角色的对话框 -->
    <el-dialog width="50%" title="分配角色" :visible.sync="setRoleDialogVisible" @close="setRoleDialogClosed">
      <div>
